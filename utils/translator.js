...
(function (factory) {
		...
		(function () {
			function loadServer(language, namespace) {
				return new Promise(function (resolve, reject) {
					let data = require('../language/'+language+'/'+namespace)
	...
	var Translator = (function () {
		...
		function Translator(language) {
			...
			translationSpaces.forEach((trans) => {
				self.translations[trans] = new Promise(function (resolve, reject) {
					resolve(require('../language/'+self.lang+'/'+trans))
				})
			});
